...
public final class ImportCSVUIWizard {
    ...
    private void buildPanels() {
        ...
        for (int i = 0; i < importers.length; i++) {
            ...
            ImportCSVUIWizardPanel1 step1 = new ImportCSVUIWizardPanel1(importer);
            ImportCSVUIWizardPanel2 step2 = new ImportCSVUIWizardPanel2(importer);
        ...
        for (int i = 0; i < panels.length; i++) {
            ...
            if (c instanceof JComponent) { // assume Swing components
                ...
                jc.putClientProperty("WizardPanel_contentData", c.getName());
